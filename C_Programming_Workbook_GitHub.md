...
| :---------- | :-------------------------------- | :-------------------------------------------------- | :---------------------- | :------------------- |
| **1** | `scanf("%d", &num)`             | Input reading                                       | `num = 456`           | `num` = 456        |
| **2** | `int d1 = num % 10`             | Extract units digit:`456 % 10`                    | `6`                   | `d1` = 6           |
| **3** | `int d2 = (num / 10) % 10`      | Integer division`456 / 10 = 45`, then `45 % 10` | `5`                   | `d2` = 5           |
| **4** | `int d3 = num / 100`            | Extract hundreds digit:`456 / 100`                | `4`                   | `d3` = 4           |
...
| :---------- | :--------------------------------- | :------------------------- | :------------------ | :--------------------------------------------------------------------------------- | :------------------------------------------ |
| **1** | `if (units <= 100)`              | `250 <= 100` (`False`) | Skip                | N/A                                                                                | `bill` = 0.0                              |
| **2** | `else if (units <= 200)`         | `250 <= 200` (`False`) | Skip                | N/A                                                                                | `bill` = 0.0                              |
...
| :---------- | :------------------------- | :------------------------------ | :------------------------------ | :--------------- |
| **1** | `hrs = total_sec / 3600` | Total hours:`7384 / 3600`     | `2` (integer division)        | `hrs` = 2      |
| **2** | `total_sec % 3600`       | Remaining seconds after hours   | `7384 % 3600 = 184`           | Remainder = 184  |
| **3** | `min = 184 / 60`         | Minutes from remaining seconds  | `184 / 60 = 3`                | `min` = 3      |
...
| :---------- | :---------------------------------- | :---------------------------------- | :------------------- | :------------------------ |
| **1** | `hra = 0.20f * basic`             | HRA (20% of basic):`0.20 * 25000` | `5000.00`          | `hra` = 5000.00         |
| **2** | `da = 0.40f * basic`              | DA (40% of basic):`0.40 * 25000`  | `10000.00`         | `da` = 10000.00         |
...
| :---------- | :-------------- | :------------------- | :----------------------------- | :----------------------------------------------- |
| **1** | `a = a + b`   | `15 + 25`          | `a` = `40`, `b` = `25` | `a` stores combined total of both variables    |
| **2** | `b = a - b`   | `40 - 25`          | `a` = `40`, `b` = `15` | `b` now holds original value of `a`          |
...
| Step        | Code Line                       | Operation / Calculation     | Intermediate Value | Variable State                |
| :---------- | :------------------------------ | :-------------------------- | :----------------- | :---------------------------- |
| **1** | `abs(a - b)`                  | `abs(45 - 78) = abs(-33)` | `33`             | Absolute difference evaluated |
| **2** | `a + b + abs(a - b)`          | `45 + 78 + 33`            | `156`            | Sum of numbers + difference   |
...
| :---------- | :----------------- | :--------------------------------------------------------- | :-------------------------- | :---------------- |
| **1** | `d1` (thousands) | `1234 / 1000 = 1`                                        | `(1 + 5) % 10 = 6 % 10`   | `d1` = 6        |
| **2** | `d2` (hundreds)  | `(1234 / 100) % 10 = 12 % 10 = 2`                        | `(2 + 5) % 10 = 7 % 10`   | `d2` = 7        |
| **3** | `d3` (tens)      | `(1234 / 10) % 10 = 123 % 10 = 3`                        | `(3 + 5) % 10 = 8 % 10`   | `d3` = 8        |
...
| :----------- | :------------------------------- | :----------------------------------------- | :---------------------------------------- | :-------------------- |
| **0**  | ₹500                            | `2893 / 500 = 5`                         | `2893 % 500 = 393`                      | `500:5`             |
| **1**  | ₹200                            | `393 / 200 = 1`                          | `393 % 200 = 193`                       | `200:1`             |
| **2**  | ₹100                            | `193 / 100 = 1`                          | `193 % 100 = 93`                        | `100:1`             |
| **3**  | ₹50                             | `93 / 50 = 1`                            | `93 % 50 = 43`                          | `50:1`              |
| **4**  | ₹20                             | `43 / 20 = 2`                            | `43 % 20 = 3`                           | `20:2`              |
| **5**  | ₹10                             | `3 / 10 = 0`                             | `3 % 10 = 3`                            | `10:0`              |
| **6**  | ₹5                              | `3 / 5 = 0`                              | `3 % 5 = 3`                             | `5:0`               |
| **7**  | ₹2                              | `3 / 2 = 1`                              | `3 % 2 = 1`                             | `2:1`               |
| **8**  | ₹1                              | `1 / 1 = 1`                              | `1 % 1 = 0`                             | `1:1`               |
...
| :---------- | :-------------------------------------------- | :------------------------ | :------------------- | :--------------------------------------- |
| **1** | `scanf("%d %d", &num1, &num2)`              | Input parsed successfully | `num1=15, num2=15` | Proceed to condition                     |
...
| :---------- | :-------------- | :------------------------------ | :--------------------- | :------------------------------ |
| **1** | `num % 2`     | `15 % 2` -> Remainder = `1` | `1 == 0` (`False`) | Skip`if` branch               |
...
| :---------- | :------------------ | :------------------------- | :-------- | :-------------------------------------- |
| **1** | `year % 400 == 0` | `2016 % 400 = 16`        | `False` | `False`                               |
| **2** | `year % 4 == 0`   | `2016 % 4 = 0`           | `True`  | Left of`&&` is `True`               |
| **3** | `year % 100 != 0` | `2016 % 100 = 16 != 0`   | `True`  | Right of`&&` is `True`              |
...
| :---------- | :------------------------------------- | :------------------ | :--------------- | :------------------------------- |
| **1** | `if (m > 0)`                         | `-5 > 0`          | `False`        | Skip`if` body                  |
| **2** | `else if (m == 0)`                   | `-5 == 0`         | `False`        | Skip`else if` body             |
...
| :---------- | :--------------------------------- | :-------------------------------------------------- | :------------- | :---------------------------------------------------- |
| **1** | `if (n1 >= n2 && n1 >= n3)`      | `12 >= 25` (`False`) `&& 12 >= 52`            | `False`      | Skip branch                                           |
| **2** | `else if (n2 >= n1 && n2 >= n3)` | `25 >= 12` (`True`) `&& 25 >= 52` (`False`) | `False`      | Skip branch                                           |
...
| :---------- | :------------------------------------ | :--------------------------------------------------------------------- | :-------------- | :------------------------------------- |
| **1** | `tolower(ch)`                       | Convert to lowercase                                                   | `'k'`         | `lower = 'k'`                        |
| **2** | Vowel Check (`lower == 'a' \|\| ...`) | `'k' == 'a' \|\| 'k' == 'e' \|\| 'k' == 'i' \|\| 'k' == 'o' \|\| 'k' == 'u'` | `False`       | Skip`if` block                       |
...
| :------------------- | :--------------------- | :---------------------- | :----------------------------------------------------- |
| **0**          | `1`                  | `arr[0] = 1`          | Stored element at index 0                              |
| **1**          | `1`                  | `arr[1] = 1`          | Stored element at index 1                              |
| **2**          | `2`                  | `arr[2] = 2`          | Stored element at index 2                              |
| **3..8**       | `3, 4, 5, 6, 7, 8`   | `arr[3..8]` populated | Stored elements at indices 3 to 8                      |
...
| :--------------------- | :---------------------------------- | :----------------------------- | :---------------- | :-------------------------------- |
| **1**            | `i = 2`                           | `arr[2] = 7`                 | Print`7 `       | Next:`i = 1`                    |
| **2**            | `i = 1`                           | `arr[1] = 5`                 | Print`5 `       | Next:`i = 0`                    |
...
int main() {
    ...
    printf("Sum of all elements stored in the array is : 15\n", sum);
    return 0;
}
```
...
| :-------------- | :------------------------- | :----------------- | :--------------------------- | :----------------------------------------------------------- |
| **0**     | `arr[0] = 2`             | `0 + 2`          | `2`                        | Initial element added                                        |
| **1**     | `arr[1] = 5`             | `2 + 5`          | `7`                        | Accumulated sum updated                                      |
...
| :-------------- | :----------------------------- | :--------------------------- | :--------------------------------- |
| **0**     | `source[0] = 15`             | `dest[0] = source[0]`      | `dest` = `[15, 0, 0]`          |
| **1**     | `source[1] = 10`             | `dest[1] = source[1]`      | `dest` = `[15, 10, 0]`         |
...
int main() {
    ...
    printf("Total number of duplicate elements found in the array is : 1\n", dupes);
    return 0;
}
```
...
| :-------------- | :------------------- | :----------------- | :-------------------------------- | :------------------------------- | :-------- | :-------------------- |
| **0**     | `5`                | `j = 1, 2`       | `5 == 1` (F), `5 == 1` (F)    | `[0, 0, 0]`                    | `1`     | `0`                 |
| **1**     | `1`                | `j = 2`          | `1 == 1` (`True`)             | `[0, 0, 1]` (`visited[2]=1`) | `2`     | `1` (`count > 1`) |
...
| :-------------- | :------------------------ | :-------------------------- | :------------------------------------------- | :---------------- | :---------------- |
| **0**     | `3`                     | `j = 1, 2, 3`             | No match                                     | `1` (`True`)  | Print`3 `       |
| **1**     | `2`                     | `j = 2`                   | `arr[1] == arr[2]` (`2 == 2`)            | `0` (`False`) | Skip (not unique) |
| **2**     | `2`                     | `j = 1`                   | `arr[2] == arr[1]` (`2 == 2`)            | `0` (`False`) | Skip (not unique) |
...
| :---------- | :--------------------- | :-------------------------------- | :--------------- | :-------------------------------- | :---------------- |
| **1** | `i=0, j=0, k=0`      | `3 >= 3` (`True`)             | `a[0] = 3`     | `[3]`                           | `i=1, j=0, k=1` |
| **2** | `i=1, j=0, k=1`      | `2 >= 3` (`False`)            | `b[0] = 3`     | `[3, 3]`                        | `i=1, j=1, k=2` |
| **3** | `i=1, j=1, k=2`      | `2 >= 2` (`True`)             | `a[1] = 2`     | `[3, 3, 2]`                     | `i=2, j=1, k=3` |
| **4** | `i=2, j=1, k=3`      | `1 >= 2` (`False`)            | `b[1] = 2`     | `[3, 3, 2, 2]`                  | `i=2, j=2, k=4` |
...
| :------------ | :----------------- | :-------------------- | :--------------------- | :---- | :----------------------- |
| **0**   | `25`             | `0` (Unvisited)     | `12, 43` (No match)  | `1` | `"25 occurs 1 times "` |
...
| :-------------- | :------------------- | :---------------------- | :--------------------- | :--------------- | :--------------- |
| **0**     | `45`               | N/A (Initialization)    | N/A (Initialization)   | `45`           | `45`           |
| **1**     | `25`               | `25 > 45` (`False`) | `25 < 45` (`True`) | `45`           | `25`           |
...
| :--------------- | :------------------- | :---------------------------------- | :----------- | :------------------------------------ | :--------------------- |
| **0**      | `25`               | `25 % 2 = 1` (`False`)          | `odd`      | `odd[0] = 25`                       | `eCount=0, oCount=1` |
| **1**      | `47`               | `47 % 2 = 1` (`False`)          | `odd`      | `odd[1] = 47`                       | `eCount=0, oCount=2` |
| **2**      | `42`               | `42 % 2 = 0` (`True`)           | `even`     | `even[0] = 42`                      | `eCount=1, oCount=2` |
| **3**      | `56`               | `56 % 2 = 0` (`True`)           | `even`     | `even[1] = 56`                      | `eCount=2, oCount=2` |
...
| :--------------------- | :-------------------------------------------------- | :------------------------------- | :---------------------- | :---------------------------------------- |
| **0**            | `'w'`                                             | `True`                         | Increment`len`        | `1`                                     |
| **1**            | `'3'`                                             | `True`                         | Increment`len`        | `2`                                     |
| **2..13**        | `'r','e','s','o','u','r','c','e','.','c','o','m'` | `True`                         | Increment`len`        | `14`                                    |
...
| :------------------- | :------------------------------ | :-------------------------------------- | :----------- | :----------------------------------- |
| **0**          | `'s'`                         | `True`                                | Print`s `  | `"s "`                             |
| **1**          | `'t'`                         | `True`                                | Print`t `  | `"s t "`                           |
| **2..6**       | `'e','l','l','a','r'`         | `True`                                | Print chars  | `"s t e l l a r "`                 |
...
| **1** | `i = 6`                             | `'r'`                | Print`'r '` | `"r "`             |
| **2** | `i = 5`                             | `'a'`                | Print`'a '` | `"r a "`           |
| **3** | `i = 4`                             | `'l'`                | Print`'l '` | `"r a l "`         |
| **4** | `i = 3`                             | `'l'`                | Print`'l '` | `"r a l l "`       |
| **5** | `i = 2`                             | `'e'`                | Print`'e '` | `"r a l l e "`     |
...
| :--------------- | :-------------------------- | :------------ | :----------------- | :-------------------------------- | :-------------- |
| **0**      | `'w'`                     | `True`      | `0`              | Start of Word 1 ->`in_word = 1` | `1`           |
| **1..6**   | `'e','l','c','o','m','e'` | `True`      | `1`              | Inside Word 1                     | `1`           |
| **7**      | `' '` (Space)             | `False`     | `1`              | Word boundary ->`in_word = 0`   | `1`           |
| **8**      | `'t'`                     | `True`      | `0`              | Start of Word 2 ->`in_word = 1` | `2`           |
| **9**      | `'o'`                     | `True`      | `1`              | Inside Word 2                     | `2`           |
| **10**     | `' '` (Space)             | `False`     | `1`              | Word boundary ->`in_word = 0`   | `2`           |
| **11**     | `'s'`                     | `True`      | `0`              | Start of Word 3 ->`in_word = 1` | `3`           |
...
| :------------------ | :------------------------------ | :----------------------- | :----------------- | :------------------------------------- |
| `"Welcome"`       | `'W','e','l','c','o','m','e'` | `isalpha() == True`    | `alphabets += 7` | `alphabets=7, digits=0, specials=0`  |
| `" "`             | `' '`                         | Space                    | Skipped            | `alphabets=7, digits=0, specials=0`  |
| `"to"`            | `'t','o'`                     | `isalpha() == True`    | `alphabets += 2` | `alphabets=9, digits=0, specials=0`  |
| `" "`             | `' '`                         | Space                    | Skipped            | `alphabets=9, digits=0, specials=0`  |
| `"stellar"`       | `'s','t','e','l','l','a','r'` | `isalpha() == True`    | `alphabets += 7` | `alphabets=16, digits=0, specials=0` |
...
Second string : This is a string to be copied.
...
| :-------------- | :-------------------------- | :---------------------- | :------------------------------------- | :------------------------ |
| **0**     | `'T'`                     | `dest[0] = 'T'`       | `"T..."`                             | `1`                     |
| **1..28** | `'h'..'d'`                | `dest[i] = source[i]` | `"This is a string to be copied..."` | `29`                    |
...
| :----------- | :---------------- | :----------------- | :-------------------------- | :--------------- | :------------------------- |
| **0**  | `'W'`           | `'w'`            | `False`                   | `consonants++` | `vowels=0, consonants=1` |
| **1**  | `'e'`           | `'e'`            | `True`                    | `vowels++`     | `vowels=1, consonants=1` |
| **2**  | `'l'`           | `'l'`            | `False`                   | `consonants++` | `vowels=1, consonants=2` |
| **3**  | `'c'`           | `'c'`            | `False`                   | `consonants++` | `vowels=1, consonants=3` |
| **4**  | `'o'`           | `'o'`            | `True`                    | `vowels++`     | `vowels=2, consonants=3` |
...
| :-------------- | :---------------- | :---------- | :--------------------------------------- | :--------------------------------------- | :-------------------------- |
| **0**     | `'W'`           | `87`      | `freq[87] = 1`                         | `1`                                    | `'W'`                     |
| **1**     | `'e'`           | `101`     | `freq[101] = 1`                        | `1`                                    | `'W'`                     |
| **2**     | `'l'`           | `108`     | `freq[108] = 1`                        | `1`                                    | `'W'`                     |
| **3**     | `'c'`           | `99`      | `freq[99] = 1`                         | `1`                                    | `'W'`                     |
| **4**     | `'o'`           | `111`     | `freq[111] = 1`                        | `1`                                    | `'W'`                     |
| **5**     | `'m'`           | `109`     | `freq[109] = 1`                        | `1`                                    | `'W'`                     |
...
Student 2 -> Name: Alice, Age: 21, Marks: 92.00
...
| :------------------- | :------------------ | :------------------------------------ | :------------------ | :------------------------------------- |
| **0**          | `"John 20 85.5"`  | `name="John", age=20, marks=85.50`  | `85.50`           | Stored student 1 record                |
| **1**          | `"Alice 21 92.0"` | `name="Alice", age=21, marks=92.00` | `177.50`          | Stored student 2 record                |
...
| :---------------- | :-------------------------- | :------------------- | :---------------------------- | :------------------------- | :--------------------------------- |
| **Seconds** | `t1.sec + t2.sec`         | `50 + 30 = 80`     | `80 / 60 = 1 sec carry`     | `80 % 60 = 20`           | `res.seconds = 20`               |
| **Minutes** | `t1.min + t2.min + carry` | `45 + 20 + 1 = 66` | `66 / 60 = 1 min carry`     | `66 % 60 = 6`            | `res.minutes = 6`                |
...
| :--------------- | :-------------------------- | :------------------------------------ | :----------------------------------- | :----------------------- | :---------------------- |
| **0**      | `350.00`                  | Initial Base                          | Initial Base                         | `0`                    | `0`                   |
| **1**      | `500.00`                  | `500.00 > 350.00` (`True`)        | `500.00 < 350.00` (`False`)      | **`1`**          | `0`                   |
...
| :--------------------------- | :------------ | :------------------------ | :--------------- | :--------------------- |
| **Circle 1 Area**      | `r = 5.0`   | `3.14159 * 5.0 * 5.0`   | `78.53975`     | `"Area: 78.54"`      |
| **Circle 1 Perimeter** | `r = 5.0`   | `2 * 3.14159 * 5.0`     | `31.4159`      | `"Perimeter: 31.42"` |
...
| :--------------- | :------------------------- | :-------------------------------------------------- | :------------------ | :------------------------------------------------------------- |
| **0**      | `50000.00`               | Base initial value                                  | Initial reference   | `0`                                                          |
| **1**      | `75000.00`               | `75000.00 > 50000.00` (`True`)                  | Update max index    | **`1`**                                                |
...
| :--------------------------------------------- | :---------------------------------- | :-------------------------------- | :----------------------------- |
| **Base Days (`year * 365 + day`)**     | `2023 * 365 + 15 = 738395 + 15`   | `2023 * 365 + 20 = 738395 + 20` | `days1=738410, days2=738415` |
| **Month Additions (Jan..Jul)**           | `+ (31+28+31+30+31+30+31) = +212` | `+ 212`                         | `days1=738622, days2=738627` |
...
| :---------------------------- | :----------------------- | :--------------------- | :-------------------- | :------------------------------- | :------------------------ |
| **`enqueue(&q, 10)`** | First element added      | Set`front = 0`       | Increment`rear = 0` | `items[0] = 10`                | N/A                       |
| **`enqueue(&q, 20)`** | Queue non-empty          | `front = 0`          | Increment`rear = 1` | `items[1] = 20`                | N/A                       |
...
| :------------------ | :-------------------- | :------------------------------------------ | :-------------- | :-------------------- |
| **Sum Real**  | `c1.real + c2.real` | `3.0 + 1.0`                               | `4.0`         | `sum.real = 4.0`    |
| **Sum Imag**  | `c1.imag + c2.imag` | `2.0 + 7.0`                               | `9.0`         | `sum.imag = 9.0`    |
| **Prod Real** | `(ac - bd)`         | `(3.0 * 1.0) - (2.0 * 7.0) = 3.0 - 14.0`  | `-11.0`       | `prod.real = -11.0` |
...
| :---------- | :---------------------- | :------------------------- | :------------------------------------ | :--------------------------------------------------------------- |
| **1** | `scanf(...)`          | Read struct fields         | `id=1, model="Sedan", rate=1500.00` | N/A                                                              |
...
| :----------------------- | :------------------------------- | :-------------------------- | :------------------------- | :------------------------------------------ |
| **`z`**          | Value stored in pointer`z`     | `0x7ffd61ad5a4c` (`&m`) | N/A                        | `z stores address of m = 0x7ffd61ad5a4c`  |
| **`*z`**         | Dereference`z`                 | Address`0x7ffd61ad5a4c`   | `10` (value of `m`)    | `*z stores value of m = 10`               |
| **`&m`**         | Address-of operator on`m`      | `0x7ffd61ad5a4c`          | N/A                        | `&m is address of m = 0x7ffd61ad5a4c`     |
...
| :--------------- | :----------------------- | :------------------ | :---------------------- | :--------------------------- | :--------------------------------------------- |
| **1**      | `int m = 29; ab = &m;` | `29`              | `&m`                  | `29`                       | Pointer`ab` bound to variable `m`          |
| **2**      | `m = 34;`              | `34`              | `&m`                  | `34`                       | Direct assignment to`m` updates `*ab`      |
...
| :------- | :---------------------------------- | :--------------------------------- | :-------------- | :------------------------------------ |
| `m`    | `&m` (e.g., `0x7ffc4f9026dc`)   | `*(&m)`                          | `300`         | `*` and `&` cancel each other out |
...
| :---------- | :---------------- | :-------------------- | :--------------- | :------------------------------------------------ |
| **1** | `*p`            | Fetch value at`&f`  | `5`            | N/A                                               |
| **2** | `*q`            | Fetch value at`&s`  | `6`            | N/A                                               |
...
| :------------------ | :----------------- | :------------------------- | :----------------------------------- | :----------------------------------------- |
| `main()`          | `&n1, &n2, &sum` | N/A                        | Invoke`addNumbers(...)`            | Pauses execution                           |
| `addNumbers(...)` | Addresses          | `a=&n1, b=&n2, sum=&sum` | `*sum = *a + *b` -> `5 + 6 = 11` | Writes`11` directly into `sum` address |
...
| :---------- | :----------------- | :--------------------------------- | :-------------------- | :----------------------------------- |
| **1** | `if (*pa > *pb)` | `*pa` -> `5`, `*pb` -> `6` | `5 > 6` (`False`) | Skip`if` body                      |
...
| :----------- | :--------------------------- | :-------------------------------- | :---------------------------------- | :-------------------- |
| **0**  | `ptr + 0`                  | `0 bytes`                       | `arr[0] = 5`                      | `"element - 0 : 5"` |
| **1**  | `ptr + 1`                  | `+4 bytes`                      | `arr[1] = 7`                      | `"element - 1 : 7"` |
| **2**  | `ptr + 2`                  | `+8 bytes`                      | `arr[2] = 2`                      | `"element - 2 : 2"` |
...
| :----------------- | :----------------- | :----------------------- | :------------------- | :-------------------------------------------------------- |
| `l = 0`          | `i = 0`          | `swap(0, 0)`           | `"abcd"`           | Call`permute(str, 1, 3)`                                |
| `l = 1`          | `i = 1`          | `swap(1, 1)`           | `"abcd"`           | Call`permute(str, 2, 3)`                                |
...
| :---------------- | :------------------------------- | :--------------------- | :------------------------ | :------------------- | :--------------------- |
| **0**       | `arr + 0`                      | `5.0`                | Initial Base              | `5.0`              | Allocated              |
| **1**       | `arr + 1`                      | `7.0`                | `7.0 > 5.0` (`True`)  | `7.0`              | Allocated              |
| **2**       | `arr + 2`                      | `2.0`                | `2.0 > 7.0` (`False`) | `7.0`              | Allocated              |
| **3**       | `arr + 3`                      | `9.0`                | `9.0 > 7.0` (`True`)  | **`9.0`**    | Allocated              |
...
| :------------- | :------------------------------- | :--------------------------- | :---------------- | :------------------------------ |
| **1**    | `'w'`                          | `True`                     | `len = 1`       | `ptr` -> `'3'`              |
| **2**    | `'3'`                          | `True`                     | `len = 2`       | `ptr` -> `'r'`              |
| **3..9** | `'r','e','s','o','u','r','c'`  | `True`                     | `len = 9`       | `ptr` -> `'e'`              |
...
| :------------------------- | :-------------------------- | :--------------------------- | :---------------------------- | :--------------------------------------------- |
| **0**                | `(0 + 1) * 10 = 10`       | `arr[0] = 10`              | `[10, _, _, _, _]`          | Memory block initialized                       |
| **1**                | `(1 + 1) * 10 = 20`       | `arr[1] = 20`              | `[10, 20, _, _, _]`         | Memory block populated                         |
| **2**                | `(2 + 1) * 10 = 30`       | `arr[2] = 30`              | `[10, 20, 30, _, _]`        | Memory block populated                         |
| **3**                | `(3 + 1) * 10 = 40`       | `arr[3] = 40`              | `[10, 20, 30, 40, _]`       | Memory block populated                         |
...
| :---------------- | :----------------- | :---------------------------- | :--------------------- | :--------------- | :-------------- |
| **0**       | `12`             | Initial Base                  | Initial Base           | `12`           | Active Heap     |
| **1**       | `45`             | `45 > 12` (`True`)        | Update`max`          | **`45`** | Active Heap     |
| **2**       | `23`             | `23 > 45` (`False`)       | Keep current`max`    | `45`           | Active Heap     |
...
| :---------------- | :---------------------------------- | :---------------------- | :------------------- | :--------------- |
| **1**       | `i = 4`                           | `arr[4] = 5`          | Print`5 `          | `"5 "`         |
| **2**       | `i = 3`                           | `arr[3] = 4`          | Print`4 `          | `"5 4 "`       |
| **3**       | `i = 2`                           | `arr[2] = 3`          | Print`3 `          | `"5 4 3 "`     |
| **4**       | `i = 1`                           | `arr[1] = 2`          | Print`2 `          | `"5 4 3 2 "`   |
...
| :---------------- | :----------------------- | :------------------------------- | :--------------------------- |
| **0**       | `10.50`                | `0.0 + 10.50`                  | `10.50`                    |
| **1**       | `20.50`                | `10.50 + 20.50`                | `31.00`                    |
| **2**       | `30.00`                | `31.00 + 30.00`                | `61.00`                    |
| **3**       | `40.00`                | `61.00 + 40.00`                | **`101.00`**         |
...
| :------------------------ | :-------------------------------- | :--------------------------- | :------------------ | :---------------------------------- |
| **1. Allocation**   | `malloc(3 * sizeof(int))`       | Allocated 12 bytes           | `[1, 2, 3]`       | Populated initial 3 elements        |
| **2. Reallocation** | `realloc(arr, 5 * sizeof(int))` | Expanded to 20 bytes         | `[1, 2, 3, ?, ?]` | Existing data preserved             |
| **3. Extension**    | `arr[3]=4; arr[4]=5;`           | 20 bytes populated           | `[1, 2, 3, 4, 5]` | Added new values to expanded buffer |
...
| :------------------ | :------------ | :-------------------- | :-------------------------- | :---------------------------- |
| **Shift 1**   | `i = 4`     | `arr[4] = arr[3]`   | `[10, 20, 30, 40, 40]`    | Element`40` shifted right   |
| **Shift 2**   | `i = 3`     | `arr[3] = arr[2]`   | `[10, 20, 30, 30, 40]`    | Element`30` shifted right   |
| **Loop End**  | `i = 2`     | Reached`pos = 2`    | `[10, 20, 30, 30, 40]`    | Slot at index 2 ready         |
...
| :-------------------- | :------------------ | :--------------------------- | :--------------------- | :---------------------------- |
| **1 (`i=1`)** | `arr[1] = arr[2]` | `20` overwritten by `30` | `[10, 30, 30, 40]`   | `3`                         |
| **2 (`i=2`)** | `arr[2] = arr[3]` | `30` overwritten by `40` | `[10, 30, 40, 40]`   | `3`                         |
...
| :---------------------- | :---------------------------------- | :-------------------- | :-------------------------------- | :-------------------------------------------------- |
| **1. Length**     | Count`src` characters             | N/A                   | Iterates until`'\0'`            | `len = 25`                                        |
| **2. Allocation** | `malloc((25 + 1) * sizeof(char))` | Allocated`26 bytes` | Reserved memory for string + null | `dest` pointer assigned                           |
| **3. Loop Copy**  | `for (i = 0; i <= 25; i++)`       | 26 bytes written      | `dest[i] = src[i]`              | Copies characters`'D'..'n'` + `'\0'`            |
...
| :---------------------- | :---------------------- | :------------------------------- | :----------------------------------- | :--------------------- | :------------------------ |
| **0 (`val 3`)** | **6 (`val 3`)** | `[3, 2, 4, 5, 2, 6, 3]`        | `3 == 3` (`True`)                | `3+2+4+5+2+6+3 = 25` | **`maxSum = 25`** |
...
| :----------- | :-------------- | :--------------------------------- | :----------------------- | :--------------- | :-------------------------------- | :-------------- |
| **0**  | `'a'`         | `-1`                             | `start = 0`            | `"a"`          | `1`                             | `1`           |
| **1**  | `'b'`         | `-1`                             | `start = 0`            | `"ab"`         | `2`                             | `2`           |
| **2**  | `'c'`         | `-1`                             | `start = 0`            | `"abc"`        | `3`                             | **`3`** |
| **3**  | `'a'`         | `0` (`>= 0`)                   | `start = 1`            | `"bca"`        | `3 - 1 + 1 = 3`                 | `3`           |
| **4**  | `'b'`         | `1` (`>= 1`)                   | `start = 2`            | `"cab"`        | `4 - 2 + 1 = 3`                 | `3`           |
| **5**  | `'c'`         | `2` (`>= 2`)                   | `start = 3`            | `"abc"`        | `5 - 3 + 1 = 3`                 | `3`           |
